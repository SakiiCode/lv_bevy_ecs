...
use lightvgl_sys::{lv_color_t, lv_observer_get_user_data, lv_subject_t};
...
impl Subject {
    // TODO make lv_subject_... functions autogenerated
    pub fn set_int(&mut self, value: i32) {
        unsafe { lightvgl_sys::lv_subject_set_int(self.raw_mut(), value) }
    }

    pub fn set_string(&mut self, value: &CStr) {
        unsafe {
            lightvgl_sys::lv_subject_set_pointer(self.raw_mut(), value.as_ptr().cast_mut().cast())
        }
    }

    pub fn set_color(&mut self, value: lv_color_t) {
        unsafe { lightvgl_sys::lv_subject_set_color(self.raw_mut(), value) }
    }

    pub fn get_int(&mut self) -> i32 {
        unsafe { lightvgl_sys::lv_subject_get_int(self.raw_mut()) }
    }

    pub fn get_ptr(&mut self) -> *const c_void {
        unsafe { lightvgl_sys::lv_subject_get_pointer(self.raw_mut()) }
    }

    pub fn get_color(&mut self) -> lv_color_t {
        unsafe { lightvgl_sys::lv_subject_get_color(self.raw_mut()) }
    }

    pub fn get_string(&mut self) -> &CStr {
        unsafe { CStr::from_ptr(lightvgl_sys::lv_subject_get_string(self.raw_mut())) }
    }

    pub fn get_previous_color(&mut self) -> lv_color_t {
        unsafe { lightvgl_sys::lv_subject_get_previous_color(self.raw_mut()) }
    }

    pub fn get_previous_int(&mut self) -> i32 {
        unsafe { lightvgl_sys::lv_subject_get_previous_int(self.raw_mut()) }
    }

    pub fn get_previous_string(&mut self) -> &CStr {
        unsafe { CStr::from_ptr(lightvgl_sys::lv_subject_get_previous_string(self.raw_mut())) }
    }
    pub fn get_previous_pointer(&mut self) -> *const c_void {
        unsafe { lightvgl_sys::lv_subject_get_previous_pointer(self.raw_mut()) }
    }
